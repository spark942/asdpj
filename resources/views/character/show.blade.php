			...
			<table class="table table-striped">
				...
				<tbody>
				    ...
				    <tr>
						...
						<td>{{ number_format($chartype->hp_min, 0, null, ',') }} - {{ number_format($chartype->hp_max, 0, null, ',') }} <i class="text-danger">({{ number_format(intval($chartype->hp_max * 1.1), 0, null, ',') }})</i></td>
						<td>{{ number_format($chartype->str_min, 0, null, ',') }} - {{ number_format($chartype->str_max, 0, null, ',') }} <i class="text-danger">({{ number_format(intval($chartype->str_max * 1.1), 0, null, ',') }})</i></td>
						<td>{{ number_format($chartype->vit_min, 0, null, ',') }} - {{ number_format($chartype->vit_max, 0, null, ',') }} <i class="text-danger">({{ number_format(intval($chartype->vit_max * 1.1), 0, null, ',') }})</i></td>
						<td>{{ number_format($chartype->int_min, 0, null, ',') }} - {{ number_format($chartype->int_max, 0, null, ',') }} <i class="text-danger">({{ number_format(intval($chartype->int_max * 1.1), 0, null, ',') }})</i></td>
						<td>{{ number_format($chartype->men_min, 0, null, ',') }} - {{ number_format($chartype->men_max, 0, null, ',') }} <i class="text-danger">({{ number_format(intval($chartype->men_max * 1.1), 0, null, ',') }})</i></td>
					</tr>
					@endforeach
				</tbody>
			</table>
